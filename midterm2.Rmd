    ...
    # title for the app
     titlePanel("Hourly Weather Forecast"),
         ...
         selectInput(inputId = "second",
                     ...
                     choices = c("No Selection","precipIntensity", "precipProbability", "apparentTemperature", "dewPoint", "humidity", "windSpeed", "windBearing", "visibility","cloudCover","pressure"),
    ...
    output$table1 = renderTable({
     ...
     output$distPlot = renderPlot({
       ggplot(result(), aes(x = time)) +
         geom_line(aes(y = result()$temperature, color = "temperature")) +  
         geom_line(aes(y = result()[,second()], color = paste(second()))) +
